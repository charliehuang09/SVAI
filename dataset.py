...
class Dataset(Dataset):
    def __init__(self,
        ...
        #load data
        lightning = pd.read_pickle(
            'cleanedData/lightning.pkl').iloc[years[0]:years[1]].to_numpy()
        population = pd.read_pickle(
            'cleanedData/population.pkl').iloc[years[0]:years[1]].to_numpy()
        rain = pd.read_pickle(
            'cleanedData/rain.pkl').iloc[years[0]:years[1]].to_numpy()
        biomass = pd.read_pickle(
            'cleanedData/biomass.pkl').iloc[years[0]:years[1]].to_numpy()
        temperature = pd.read_pickle(
            'cleanedData/temperature.pkl').iloc[years[0]:years[1]].to_numpy()
        humidity = pd.read_pickle(
            'cleanedData/humidity.pkl').iloc[years[0]:years[1]].to_numpy()
        wind = pd.read_pickle(
            'cleanedData/wind.pkl').iloc[years[0]:years[1]].to_numpy()
        soil_moisture = pd.read_pickle('cleanedData/soil_moisture.pkl'
                                       ).iloc[years[0]:years[1]].to_numpy()
        fireCCIL1982_2018 = pd.read_pickle(
            'cleanedData/fireCCIL1982-2018.pkl'
        ).iloc[years[0]:years[1]].to_numpy()
        mcd64 = pd.read_pickle(
            'cleanedData/MCD64.pkl').iloc[years[0]:years[1]].to_numpy()
